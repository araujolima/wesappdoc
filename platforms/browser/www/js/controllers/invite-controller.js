...
.controller('InviteController', function($scope,$cordovaSms,$ionicModal,$ionicPopup) {
		$scope.number = 5581988646019;
...
$scope.modal = $ionicModal.fromTemplate( '<ion-modal-view>' +
      ...
      '</ion-header-bar>' +
		...
		'<div class="row">'+
			...
			'</div>			<div class="col" >'+
				'<input type="text"  style="width: 100%;box-shadow: 0 0 3px #111;" ng-model="number">	'+
			'</div>		</div>'+

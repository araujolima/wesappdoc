...
angular.module('app', ['ionic','ngCordova','ngLocalStorage', 'app.controllers', 'app.services','app.home-controller','app.login-controller',
  'app.register-controller','app.invite-controller','app.transfers-controller','app.benefi-controller','app.documents-controller',
  'app.document-persist-controller','app.profile-controller','app.benefi-persist-controller','app.benefi-data-controller','ui.utils.masks'])

.run(function($ionicPlatform, $rootScope,$ionicHistory,$state,$localStorage) {

  //$rootScope.baseURL = 'http://www.infohds.com.br';
  $rootScope.baseURL = 'http://67.205.158.121';
  $rootScope.user = {};
